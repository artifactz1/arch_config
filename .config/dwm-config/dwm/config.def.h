...
static const char *upvol[]   = { "/usr/bin/pact1", "set-sink-volume", "@DEFAULT_SINK", "+5%",     NULL };
static const char *downvol[] = { "/usr/bin/pact1", "set-sink-volume", "@DEFAULT_SINK", "-5%",     NULL };
static const char *mutevol[] = { "/usr/bin/pact1", "set-sink-mute",   "@DEFAULT_SINK", "toggle",  NULL };
